  ...
  var jq = $.noConflict();
    ...
    function initBranchChosen() {
        ...
        if (jq("#branch_select").hasClass("chosen-initialized")) {
            jq("#branch_select").chosen("destroy");
            jq("#branch_select").removeClass("chosen-initialized");
        }
        ...
        jq("#branch_select").addClass("chosen-initialized");
